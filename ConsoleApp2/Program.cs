...
namespace ConsoleApp2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //    switch (Ven)
            //    {
            //        case 'а': Console.WriteLine("330 км/ч"); break;
            //        case 'в': Console.WriteLine("35 км/ч"); break;
            //        case 'м': Console.WriteLine("299 км/ч"); break;
            //        case 'с': Console.WriteLine("900 км/ч"); break;
            //        case 'п': Console.WriteLine("600 км/ч"); break;
